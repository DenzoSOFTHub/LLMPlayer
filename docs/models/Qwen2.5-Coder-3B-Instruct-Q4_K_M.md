# Qwen 2.5 Coder 3B Instruct Q4_K_M
...
**Inference Engine:** `InferenceEngine` (standard). Identical architecture to `qwen2.5-3b-instruct` but trained as a code-specialized variant. Same weight layout, same inference path.

## GPU Profile (RTX 4050 Laptop, 6140 MB VRAM)

| Version | tok/s | Mode | Notes |
|---------|-------|------|-------|
| v1.5.1 | 21.8 | CUDA graph | 36/36 layers |
| v1.6.0 | 18.7 | CUDA graph | 36/36 layers |
...
|---------|--------|-------|
| v1.5.1 | CUDA graph mode | 21.8 |
| v1.6.0 | Minor change | 18.7 |
