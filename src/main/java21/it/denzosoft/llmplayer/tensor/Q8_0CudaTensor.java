...
/**
 * CUDA GPU-accelerated Q8_0 tensor.
 * Delegates matmulParallel to CUDA GPU kernel, falls back to CPU on error.
 */
public class Q8_0CudaTensor extends CudaFloatTensor {
    ...
    public Q8_0CudaTensor(TensorData data, long size, CudaBufferManager bufferManager) {
    ...
    @Override
    protected String kernelResourcePath() { return "kernels/cuda/matmul_q8_0.cu"; }
    ...
    public float dot(long thisOffset, FloatTensor other, long otherOffset, int length) {
        if (other instanceof Q8_0FloatTensor || other instanceof Q8_0GpuTensor || other instanceof Q8_0CudaTensor) {
