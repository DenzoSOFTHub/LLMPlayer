...
/**
 * CUDA GPU-accelerated Q6_K tensor.
 * Delegates matmulParallel to CUDA GPU kernel, falls back to CPU on error.
 */
public class Q6_KCudaTensor extends CudaFloatTensor {
    ...
    public Q6_KCudaTensor(TensorData data, long size, CudaBufferManager bufferManager) {
    ...
    public float getFloat(long index) {
        ...
        int subBlock = j / 16;
        int sc = data.getByte(bo + 192 + subBlock);
