...
/**
 * CUDA GPU-accelerated Q4_0 tensor.
 * Delegates matmulParallel to CUDA GPU kernel, falls back to CPU on error.
 */
public class Q4_0CudaTensor extends CudaFloatTensor {
    ...
    public Q4_0CudaTensor(TensorData data, long size, CudaBufferManager bufferManager) {
    ...
    @Override
    protected String kernelResourcePath() { return "kernels/cuda/matmul_q4_0.cu"; }
