...
/**
 * CUDA GPU-accelerated Q5_K tensor.
 * Delegates matmulParallel to CUDA GPU kernel, falls back to CPU on error.
 */
public class Q5_KCudaTensor extends CudaFloatTensor {
    ...
    public Q5_KCudaTensor(TensorData data, long size, CudaBufferManager bufferManager) {
        ...
        for (int b = 0; b < numBlocks; b++) {
            ...
            for (int group = 0; group < 4; group++) {
                ...
                for (int ll = 0; ll < 32; ll++) {
                    ...
                    int qhByte = Byte.toUnsignedInt(qh[ll]);
