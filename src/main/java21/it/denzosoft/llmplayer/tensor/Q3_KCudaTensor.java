...
/**
 * CUDA GPU-accelerated Q3_K tensor.
 * Delegates matmulParallel to CUDA GPU kernel, falls back to CPU on error.
 */
public class Q3_KCudaTensor extends CudaFloatTensor {
    ...
    public Q3_KCudaTensor(TensorData data, long size, CudaBufferManager bufferManager) {
    ...
    @Override
    protected String kernelResourcePath() { return "kernels/cuda/matmul_q3_k.cu"; }
